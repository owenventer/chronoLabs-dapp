...
export function EmployerDashView({ }){
  ...
  return (
    ...
    <div className="md:hero mx-auto p-2 m-10">
      ...
      <div className="md:hero-content flex flex-col  items-center shadow-lg bg-black text-neutral-content bg-opacity-50 rounded mt-3">
        ...
        <div><button className="bg-[#14F195] hover:scale-105 text-black font-bold p-2 w-2/3 m-2 mx-10 rounded"> Daily Reports</button></div>
